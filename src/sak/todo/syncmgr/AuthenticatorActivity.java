...
public class AuthenticatorActivity extends AccountAuthenticatorActivity {
    ...
    public static final String PARAM_EMAIl = "emial";
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (!TextUtils.isEmpty(mEmail)) mEmailEdit.setText(mEmail);
    ...
    private void finishConfirmCredentials(boolean result) {
        ...
        mAccountManager.setUserData(account, AccountAuthenticator.EMAIL_KEY, mEmail);
    ...
    private void finishLogin(String authToken) {
        ...
        if (mRequestNewAccount) {
        	...
        	userData.putString(AccountAuthenticator.EMAIL_KEY, mEmail);
...
//            ContentResolver.setSyncAutomatically(account, ContactsContract.AUTHORITY, true);
    ...
    private CharSequence getMessage() {
        ...
        if (TextUtils.isEmpty(mEmail)) {
            ...
            return getText(R.string.login_activity_loginfail_text_emmissing);
        }
        return null;
    }
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, String> {
        ...
        protected String doInBackground(Void... params) {
            ...
            try {
                return NetworkUtilities.authenticate(mUsername, mPassword,mEmail);
            } catch (Exception ex) {
