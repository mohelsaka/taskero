...
public class CreateMultiTaskActivityUpdated extends Activity {
	int i = 1;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		TextView taskBefore = (TextView) LayoutInflater.from(
				CreateMultiTaskActivityUpdated.this).inflate(R.drawable.task,
				null);
			...
			public void onClick(View v) {
				...
				try {
					...
					Intent intent = new Intent(
							CreateMultiTaskActivityUpdated.this,
							sak.todo.timeline.Calendar.class);
		...
		findViewById(R.id.AddTask).setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				final TextView task = (TextView) LayoutInflater.from(
						CreateMultiTaskActivityUpdated.this).inflate(
				...
				if (body.isEmpty()) {
					Toast.makeText(CreateMultiTaskActivityUpdated.this,
	...
	class constraintDragListner implements OnDragListener {
		...
		public boolean onDrag(View v, DragEvent event) {
			...
			case DragEvent.ACTION_DROP:
				...
				TextView t = new TextView(CreateMultiTaskActivityUpdated.this);
				t.setText("  ");
				container.addView(t);
